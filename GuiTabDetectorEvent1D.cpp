...
CGuiTabDetectorEvent1D::CGuiTabDetectorEvent1D(CGuiBase* gui_parent,
...
CGuiTabDetectorEvent1D::~CGuiTabDetectorEvent1D()
{
...
void CGuiTabDetectorEvent1D::do_construct_tab()
{
...
void CGuiTabDetectorEvent1D::do_update(const CDetBase* detbase)
{
...
//   detbase->extract_readouts(all_readouts);
   ...
   BOOST_FOREACH(const CDetReadoutBase* rd, all_readouts) {
      ...
      //std::cout << "CGuiTabDetectorEvent1D::get_time trange=" << tr.first << " " << tr.second << std::endl;
      //std::cout << "CGuiTabDetectorEvent1D:: time bin =" << tbins << std::endl;
...
void CGuiTabDetectorEvent1D::do_clear_tab()
{
  m_qdisp.clear();
  m_tdisp.clear();
}
