...
CGuiTabPedestalCrosstalk::CGuiTabPedestalCrosstalk(CGuiBase* gui_parent, CConfiguration* config, CEventBrowser* eb, TGTab* main_tabs, const std::string& name) :
...
CGuiTabPedestalCrosstalk::~CGuiTabPedestalCrosstalk()
{
   delete m_xtalk_32;
   delete m_xtalk_all;
}

void CGuiTabPedestalCrosstalk::do_construct_tab()
{
   ...
   
   {
      ...
      m_gui_xtalk_create_map_file->Connect("Clicked()", "browser::CGuiTabPedestalCrosstalk", this, "gui_handle_create_xtalk_map_file()");
      m_tab_frame->AddFrame(m_gui_xtalk_create_map_file, new TGLayoutHints( kLHintsTop, 1, 1, 1, 1));
   }
   
   
   m_re_canvas = new TRootEmbeddedCanvas("CGuiTabPedestalCrosstalk", m_tab_frame, 100, 100);
...
void CGuiTabPedestalCrosstalk::do_clear_tab()
{ 
...
void CGuiTabPedestalCrosstalk::do_update(const CDetBase* detbase)
{
//   return;
...
void CGuiTabPedestalCrosstalk::gui_handle_create_xtalk_map_file()
{
// print out
