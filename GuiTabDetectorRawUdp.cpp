...
CGuiTabDetectorEventRawUdp::CGuiTabDetectorEventRawUdp(CGuiBase* gui_parent,
...
CGuiTabDetectorEventRawUdp::~CGuiTabDetectorEventRawUdp()
{
   
}


void CGuiTabDetectorEventRawUdp::do_construct_tab()
{
...
void CGuiTabDetectorEventRawUdp::do_update(const CDetBase* entry)
{

   const CDetDetector* det = dynamic_cast<const CDetDetector*>(entry);
   if (!det) {
      std::cout << "CGuiTabDetectorEventRawUdp::do_update no DET\n" ;
      return;
   }
   std::cout << "CGuiTabDetectorEventRawUdp::do_update ()\n" ;
   clear_tab();
...
void CGuiTabDetectorEventRawUdp::do_clear_tab()
{
   //m_rawhist.clear();
}
