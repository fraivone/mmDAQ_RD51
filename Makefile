...
SRCGUI = GuiBase.cpp GuiMainFrame.cpp GuiMainFrameOffline.cpp GuiMainFrameOnline.cpp GuiTab.cpp GuiTabChamber.cpp GuiTabDaqMonitor.cpp GuiTabDetector.cpp GuiTabDetectorCrosstalk.cpp GuiTabDetectorEvent1D.cpp GuiTabDetectorRawUdp.cpp GuiTabMainOptions.cpp GuiTabMultiLayer.cpp GuiTabPlane.cpp GuiTabPlaneAll1D.cpp GuiTabReadout.cpp GuiTabReadout1D.cpp GuiTabReadout2D.cpp GuiTabReadoutStats.cpp GuiTabReadoutProps.cpp GuiTabStrip.cpp RootThread.cpp GuiTabDetectorStats.cpp GuiTabChamberEvent1D.cpp GuiTabChamberStats.cpp
